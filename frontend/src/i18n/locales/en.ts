export default {
  ...
  keys: {
    ...
    exportBat: 'Export BAT',
    batExportSuccess: 'BAT file exported',
    batExportFailed: 'Failed to export BAT file',
    testConnection: 'Test',
    testingConnection: 'Testing...',
    testConnectionSuccess: 'Connection test passed and usage was recorded',
    testConnectionFailed: 'Connection test failed',
    testConnectionTimeout: 'Test timed out (60s)',
    testConnectionNoModel: 'No text model is available for testing',
    testConnectionNoGroup: 'Please select a group for this key first',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
