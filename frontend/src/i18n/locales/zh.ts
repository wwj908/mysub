export default {
  ...
  keys: {
    ...
    exportBat: '导出BAT',
    batExportSuccess: 'BAT文件已导出',
    batExportFailed: 'BAT文件导出失败',
    testConnection: '测试连接',
    testingConnection: '测试中...',
    testConnectionSuccess: '连接测试成功，已产生用量记录',
    testConnectionFailed: '连接测试失败',
    testConnectionTimeout: '测试超时（60秒）',
    testConnectionNoModel: '没有找到可用于测试的文本模型',
    testConnectionNoGroup: '请先为该密钥选择分组',
    enable: '启用',
    disable: '禁用',
    nameLabel: '名称',
